...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-white focus:text-slate-900 data-[state=open]:bg-white data-[state=open]:text-slate-900",
      inset && "pl-8",
      className
    )}
    {...props}
