...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-slate-200/50 data-[state=selected]:bg-slate-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-start align-middle font-medium text-slate-700 [&:has([role=checkbox])]:pe-0",
      className
    )}
    {...props}
  />
